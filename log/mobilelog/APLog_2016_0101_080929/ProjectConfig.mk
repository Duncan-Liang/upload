...
MTK_BUILD_VERNO= alps-mp-m0.mp1-V2.84_gr6737t.66.m0_P34
MTK_BWC_SUPPORT= yes
...
CUSTOM_HAL_LENS = gt9762af gt9762af_new dummy_lens
CUSTOM_HAL_MAIN_BACKUP_LENS =
CUSTOM_HAL_MAIN_IMGSENSOR = imx258_mipi_raw ov13853_mipi_raw s5k3l8_mipi_raw
CUSTOM_HAL_MAIN_LENS = gt9762af gt9762af_new dummy_lens
...
WIND_DEF_OPTR_E280L_CMCC = yes
WIND_ASUS_INCALLUI=no
WIND_BATTERY_MODIFY = yes
WIND_DEF_ASUS_SYSTEMUI=no
WIND_DEF_ASUS_APKS = no
WIND_ASUS_CONTACTS=no
WIND_DEF_OPTR_PLAY_TO=yes
WIND_WIFI_SERVER_CHANGE_CN = yes
WIND_GESTURES_SUPPORTED=yes
WOS_APP_WINDPOWERSAVER=yes
WIND_ASUS_BACKUP=no
WIND_DEF_ASUS_NOT_DISTURB=no
...
WIND_DEF_ADAPT_FOR_ASUS_APK_CN = no
WIND_DEF_ASUS_VLIFE_LOCKSCREEN = no
WIND_DEF_ASUS_ADB_FUNCTION = no
WIND_DEF_MUSIC_ASUS = no
