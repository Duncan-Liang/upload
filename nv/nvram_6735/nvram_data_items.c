...
nvram_ef_nwsel_data_struct const COMMON_NVRAM_EF_NWSEL_DATA_DEFAULT[] =
{
    ...
    #if defined(__UE_EFOPLMN__) ||(UNIT_TEST)
    ,    
    {0x00,0x00}, // version
    0,   // OPLMN_entry	
    {0}
...
{
    {
        /* nvram_ua_struct */
        {
            ...
            0x00,                   // ipv6_zero_compression = 0 (0:diable, 1:enable)
            0x00,                   // pas3
            0x00,                   // pad4
            {
        ...
        /* nvram_imc_struct */
        {
            ...
            0x00000002, // poweroff_ims_dereg_timer = 2 seconds
...
//#endif
    ...
    /* 16th byte */ 
    0x01 | //SBP_SEARCH_4G_WHEN_FIRST_PS_ATTACH
#ifdef UNIT_TEST
    0x00 |
  ...
  //0x04 | //SBP_CUSTOM_FPLMN_USED
    ...
    0x80 |  //SBP_AVOID_INTRA_LTE_PINGPONG_RESEL
#endif
    0x00,
